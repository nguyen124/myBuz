...
export class AuthService {
  ...
  loginWithGoogle() {
    window.location.href = 'https://us-central1-m2meme.cloudfunctions.net/svc/user/auth/google';
  };

  loginWithFacebook() {
    window.location.href = 'https://us-central1-m2meme.cloudfunctions.net/svc/user/auth/facebook';
  };
